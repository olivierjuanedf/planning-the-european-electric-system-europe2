...
def get_generators(country_trigram: str, fuel_sources: Dict[str, FuelSources],
    ...
    generators = [
        ...
        {"name": f"Nuclear_{country_trigram}", "carrier": "Nuclear", "p_nom": 7117.36,
        "p_min_pu": 0, "p_max_pu": 1, "marginal_cost": fuel_sources["Uranium"].primary_cost * 0.4,
        ...
        "p_nom": 41216.73, "p_min_pu": 0, "p_max_pu": wind_on_shore_data["value"].values,
        "marginal_cost": fuel_sources["Wind"].primary_cost, "efficiency": 1,
        "committable": False},
        {"name": f"Wind-off-shore_{country_trigram}", "carrier": "Wind",
        "p_nom": 88.00, "p_min_pu": 0, "p_max_pu": wind_off_shore_data["value"].values,
        "marginal_cost": fuel_sources["Wind"].primary_cost, "efficiency": 1,
        "committable": False},
        ...
        "committable": False},
        {"name": f"Solar-thermal_{country_trigram}", "carrier": "Thermal", "p_nom": 2364.50,
        "p_min_pu": 0, "p_max_pu":1,
        "marginal_cost": fuel_sources["Solar"].primary_cost, "efficiency": 1,
        "committable": False},
        ...
        "efficiency": 1, "committable": False},
        {"name": f"hydro_pump_storage_closed_loop_{country_trigram}", "carrier": "hydro_pump_storage_closed_loop",
        "p_nom": 3331.40, "p_max_pu": 1, "p_min_pu": 0, "efficiency": 1,
        "committable": False}
        {"name": f"hydro_pump_storage_open_loop_{country_trigram}", "carrier": "hydro_pump_storage_open_loop",
        "p_nom": 6522.72, "p_max_pu": 1, "p_min_pu": 0, "efficiency": 1,
        "committable": False}
        {"name": f"hydro_reservoir_{country_trigram}", "carrier": "hydro_reservoir",
        "p_nom": 15179.69}
        {"name": f"hydro_run_of_river_{country_trigram}", "carrier": "hydro_run_of_river",
        "p_nom": 3679.44}
        {"name": f"hydro_pondage_{country_trigram}", "carrier": "hydro_pondage",
        "p_nom": 266.00}
        ...
        "efficiency": 1, "committable": False},
        {"name":f"Battery_{country_trigram}", 
        "carrier": "flexibility", "p_nom":100.00, "p_min_pu": -1, "p_max_pu": 1}
        {"name": f"demand_side_response_capacity_{country_trigram}", "carrier": "demand_side_response_capacity",
        "p_nom": 500.00, "p_min_pu": 0, "p_max_pu": 1,
        "efficiency": 1, "committable": False},
    ]
    return generators
