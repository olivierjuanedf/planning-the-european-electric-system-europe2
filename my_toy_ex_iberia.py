...
uc_run_params = UCRunParams(selected_countries=selected_countries, selected_target_year=year, 
                            ...
                            selected_prod_types={"iberian-peninsula": agg_prod_types_selec},
...
"""
IV) Build PyPSA model - with unique country (Iberia here)
"""
...
#################################################
# KEY POINT: main parameters needed for Iberia description in PyPSA are set in script
# long_term_uc.toy_model_params.iberia_parameters.py
...
from long_term_uc.toy_model_params.iberia_parameters import gps_coords
coordinates = {"iberian-peninsula": gps_coords}
...
from long_term_uc.toy_model_params.iberia_parameters import get_generators
