...
(ii) copy/paste pieces of code from my_toy_ex_scandinavia.py to this created file
(iii) Also, set the parameters of your country electricity generators in file {your country}_parameters.py,
following/adapting model of long_term_uc/toy_model_params/scandinavia_parameters.py
...
# plt.show()
# Debug Marginal Prices Data
print("Marginal Prices Data (Head):")
print(network.buses_t.marginal_price.head())

# Plot Mean Marginal Prices
mean_prices = network.buses_t.marginal_price.mean(1)
if mean_prices.empty:
    print("No marginal prices to plot.")
else:
